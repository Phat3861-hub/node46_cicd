...
//describe : tiêu đề , gom nhóm các test case
// it : cụ thể 1 case

// beforeEach : chạy trước mỗi lần hàm IT chạy , thường dùng để tạo dữ liệu đầu vào
// afterEach : chạy sau mỗi lần hàm IT chạy, thường dùng để làm mới dữ liệu
...
describe("Auth Service", () => {
  ...
  it("Case 2: Trường hợp đăng ký email đã tồn tại cần báo lỗi", () => {
    // console.log("Case 2");
  });
});
